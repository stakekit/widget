...
describe("makeScopedSerialOperations", () => {
  it.effect("runs operations serially", () =>
    Effect.gen(function* () {
  ...
  it.effect(
    "interrupts an in-flight operation when its owner Scope closes",
    () =>
      Effect.gen(function* () {
        const result = yield* Effect.scoped(
          Effect.gen(function* () {
  ...
  it.effect("propagates caller interruption to the scoped operation", () =>
    Effect.gen(function* () {
      const result = yield* Effect.scoped(
        Effect.gen(function* () {
          const operations = yield* makeScopedSerialOperations();
  ...
  it.effect(
    "interrupts semaphore waiters and does not start operations after close",
    () =>
      Effect.gen(function* () {
        const result = yield* Effect.scoped(
          Effect.gen(function* () {
