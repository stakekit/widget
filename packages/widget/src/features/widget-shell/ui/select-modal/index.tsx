...
import { SearchIcon } from "../../../../shared/ui/primitives/icons/search";
import { XIcon } from "../../../../shared/ui/primitives/icons/x-icon";
import { ListItem } from "../../../../shared/ui/primitives/list/list-item";
import type { ItemContainerVariants } from "../../../../shared/ui/primitives/list/styles.css";
...
const SelectModalWithoutState = ({
  ...
  const configuredPortalContainer = useWidgetConfig("portalContainer");
...
export const SelectModalItem = ({
  ...
  const themeVariant = useWidgetConfig("variant");
