...
import { getBorrowDetailsModel } from "../../model/borrow-details-model";
import type { BorrowFormProjection } from "../../model/borrow-form";
import type { BorrowMarketWalletBalances } from "../../model/wallet-balances";
