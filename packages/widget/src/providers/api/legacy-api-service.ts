...
export const makeLegacyApiService = (legacy: LegacyApi.LegacyApi) => {
  const scanTokenBalances = Effect.fn(
    "StakeKitApiService.legacy.scanTokenBalances"
  ...
  const getGasTokenBalances = Effect.fn(
    "StakeKitApiService.legacy.getGasTokenBalances"
  ...
  const getPrices = Effect.fn("StakeKitApiService.legacy.getPrices")(function* (
  ...
  const getEnabledNetworks = Effect.fn(
    "StakeKitApiService.legacy.getEnabledNetworks"
  )(function* () {
    return yield* legacy
  ...
  const getLegacyTokenOptions = Effect.fn(
    "StakeKitApiService.legacy.getLegacyTokenOptions"
  ...
  const scanEarnTokenBalances = Effect.fn(
    "StakeKitApiService.legacy.scanEarnTokenBalances"
  )(function* (request: {
  ...
  const getRewardsSummaries = Effect.fn(
    "StakeKitApiService.legacy.getRewardsSummaries"
  )(function* (request: {
