...
import { widgetBootstrapConfigAtom } from "../../effect-atom-runtime/bootstrap-config";
import {
...
import { type WagmiActionOperations, wagmiActionOperations } from "./actions";
import type { BuildWagmiConfigOptions } from "./config";
...
export const walletInitializationKeyAtom = (() => {
  ...
  return Atom.make((get) => {
    ...
    return new WalletInitializationKey({
      ...
      ...(externalProviders && {
        externalProviders:
          externalProvidersRef as RefObject<SKExternalProviders>,
      }),
