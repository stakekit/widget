...
import { makeBorrowWalletStateAtom } from "../../../borrow/wallet/atoms";
import type { AdditionalAddresses } from "../../../domain/schema/address-models";
import { dynamicExternalProviderInputAtom } from "../../effect-atom-runtime/root-inputs";
import {
...
export const borrowWalletStateAtom = Atom.family(
  (key: WalletInitializationKey) =>
    makeBorrowWalletStateAtom(walletStateAtom(key))
);
...
export const useWalletInitializationKey = (): WalletInitializationKey =>
  useAtomValue(walletInitializationKeyAtom);
