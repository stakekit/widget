...
export const IntegrationMetadataDto = Schema.Struct({
...
export const PositionStateDto = Schema.Struct({
...
}).annotate({ identifier: "PositionStateDto" });
...
export const ArgumentsDto = Schema.Struct({
...
export const ActionMetadataDto = Schema.Struct({
  ...
  predictedHealthFactor: Schema.Union([Schema.String, Schema.Null]).annotate({
    description:
...
}).annotate({ identifier: "ActionDefinitionDto" });
...
}).annotate({ identifier: "CollateralTokenDto" });
...
export const BorrowPendingActionDto = Schema.Struct({
  ...
  args: Schema.suspend((): Schema.Codec<ArgumentsDto> => ArgumentsDto).annotate(
    { description: "Pre-filled arguments for the action" }
  ),
}).annotate({ identifier: "BorrowPendingActionDto" });
...
export const ActionDto = Schema.Struct({
  ...
  rawArguments: Schema.optionalKey(
    Schema.suspend((): Schema.Codec<ArgumentsDto> => ArgumentsDto).annotate({
...
export const IntegrationDto = Schema.Struct({
  ...
  metadata: Schema.suspend(
    (): Schema.Codec<IntegrationMetadataDto> => IntegrationMetadataDto
  ).annotate({
...
}).annotate({ identifier: "IntegrationDto" });
...
export const MarketDto = Schema.Struct({
  ...
  loanToken: Schema.suspend((): Schema.Codec<TokenDto> => TokenDto).annotate({
...
export const SupplyBalanceDto = Schema.Struct({
  ...
  positionState: Schema.optionalKey(
    Schema.suspend(
      (): Schema.Codec<PositionStateDto> => PositionStateDto
    ).annotate({
      description:
...
}).annotate({ identifier: "SupplyBalanceDto" });
