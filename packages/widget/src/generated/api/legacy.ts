...
export type CampaignSimulationRunDto = {
  ...
  readonly resultSummary: { readonly [x: string]: unknown } | null;
...
export type Team = {
  ...
  readonly contactDetails: { readonly [x: string]: unknown };
...
export type CreateFeeConfigurationDtoV2 = {
  ...
  readonly layerzeroOVaultConfig?: { readonly [x: string]: unknown };
};
...
export type MfaWebauthnRegisterVerifyDto = {
  readonly credential: { readonly [x: string]: unknown };
  readonly label?: string;
};
...
export type CreateValidatorProviderDto = {
  ...
  readonly revshare?: { readonly [x: string]: unknown };
};
...
export type ValidatorHistoricalRevshareChangesDto = {
  ...
  readonly lastDay: string;
  readonly preferred?: { readonly [x: string]: unknown };
  readonly apr?: { readonly [x: string]: unknown };
  readonly commission?: { readonly [x: string]: unknown };
  readonly mevCommission?: { readonly [x: string]: unknown };
};
...
export type WebhookEndpointDto = {
  ...
  readonly url: string;
  readonly enabled: boolean;
  readonly description?: { readonly [x: string]: unknown };
  readonly createdAt: string;
  readonly updatedAt: string;
...
export type WebhookSubscriptionDto = {
  ...
  readonly filtersJson?: { readonly [x: string]: unknown };
  readonly enabled: boolean;
  readonly createdAt: string;
  readonly updatedAt: string;
};
...
export type WebhookEventDto = {
  ...
  readonly type: string;
  readonly subjectJson: { readonly [x: string]: unknown };
  readonly dataJson: { readonly [x: string]: unknown };
...
export type CreateRiskParameterDto = {
  ...
  readonly value: { readonly [x: string]: unknown };
  readonly network?: Networks;
...
export type RiskParameterDto = {
  ...
  readonly value?: { readonly [x: string]: unknown };
  readonly network?: Networks;
  readonly asset?: { readonly [x: string]: unknown };
  readonly protocol?: { readonly [x: string]: unknown };
  readonly integrationId?: { readonly [x: string]: unknown };
  readonly createdAt: string;
  readonly updatedAt: string;
};
...
export type TransactionStatusResponseDto = {
  ...
  readonly raw: { readonly [x: string]: unknown };
};
...
export type ProgrammaticPerpReportingEventOrderDto = {
  ...
  readonly clientOrderId: { readonly [x: string]: unknown } | null;
...
export type StakeViewSuccessDto = {
  ...
  readonly rewards: ReadonlyArray<{ readonly [x: string]: unknown }>;
  readonly details:
...
export type SsoConfigResponseDto = {
  ...
  readonly attributeMapping: { readonly [x: string]: unknown };
  readonly enabled: boolean;
...
export type UpsertSsoConfigDto = {
  readonly protocol: "saml" | "oidc";
  readonly issuer: string;
  readonly entryPoint?: { readonly [x: string]: unknown };
  readonly certificate?: { readonly [x: string]: unknown };
  readonly clientId?: { readonly [x: string]: unknown };
...
export type ValidatorAdminDto = {
  ...
  readonly address: string;
  readonly status: ValidatorStatusTypes;
  readonly lastFoundAt?: { readonly [x: string]: unknown };
  readonly provider?: ValidatorProviderDto;
  readonly providerId?: { readonly [x: string]: unknown };
  readonly name?: { readonly [x: string]: unknown };
  readonly nameOverride?: { readonly [x: string]: unknown };
  readonly website?: { readonly [x: string]: unknown };
  readonly websiteOverride?: { readonly [x: string]: unknown };
  readonly image?: { readonly [x: string]: unknown };
  readonly imageOverride?: { readonly [x: string]: unknown };
  readonly apr?: { readonly [x: string]: unknown };
  readonly aprOverride?: { readonly [x: string]: unknown };
  readonly commission?: { readonly [x: string]: unknown };
  readonly commissionOverride?: { readonly [x: string]: unknown };
  readonly mevCommission?: { readonly [x: string]: unknown };
  readonly mevCommissionOverride?: { readonly [x: string]: unknown };
  readonly stakedBalance?: { readonly [x: string]: unknown };
  readonly votingPower?: { readonly [x: string]: unknown };
  readonly remainingPossibleStake?: { readonly [x: string]: unknown };
  readonly minimumStake?: { readonly [x: string]: unknown };
  readonly remainingSlots?: { readonly [x: string]: unknown };
  readonly endDate?: { readonly [x: string]: unknown };
  readonly nominatorCount?: { readonly [x: string]: unknown };
  readonly subnetId?: { readonly [x: string]: unknown };
  readonly createdAt: string;
  readonly updatedAt: string;
};
...
export type ProgrammaticPerpReportingActionDto = {
  ...
  readonly providerId: string;
  readonly address: string;
  readonly args: { readonly [x: string]: unknown };
...
export const make = (
  ...
  const decodeVoidError =
    ...
    (response: HttpClientResponse.HttpClientResponse) =>
      Effect.fail(LegacyApiError(tag, undefined, response));
  const binaryRequest = (
    request: HttpClientRequest.HttpClientRequest
  ...
  return {
    ...
    AuthControllerLogout: (options) =>
      HttpClientRequest.post("/v1/auth/logout").pipe(
        onRequest(options?.config)([], undefined, {
          binary: [],
          voidSuccess: ["204"],
          voidError: [],
        })
    ...
    CampaignControllerList: (teamId, projectId, options) =>
      __makePathRequest(
        ...
        () =>
          "/v1/teams/" +
          __encodePathParam(teamId) +
          "/projects/" +
          __encodePathParam(projectId) +
          "/campaigns"
      ).pipe(
    ...
    CampaignControllerCreate: (teamId, projectId, options) =>
      __makePathRequest(
        ...
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.bodyJsonUnsafe(options.payload),
            onRequest(options.config)(["2xx"], undefined, {
              binary: [],
              voidSuccess: [],
              voidError: ["403"],
            })
    ...
    CampaignControllerGetById: (teamId, projectId, campaignId, options) =>
      __makePathRequest(
        ...
        () =>
          ...
          __encodePathParam(projectId) +
          "/campaigns/" +
          __encodePathParam(campaignId) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(onRequest(options?.config)(["2xx"]))
        )
      ),
    ...
    CampaignControllerSetUserPayoutEligibility: (
      ...
      __makePathRequest(
        HttpClientRequest.patch,
        [teamId, projectId, campaignId, address],
        () =>
          "/v1/teams/" +
          __encodePathParam(teamId) +
          "/projects/" +
    ...
    CampaignControllerGetPayoutRunDetail: (
      ...
      __makePathRequest(
        HttpClientRequest.get,
        [teamId, projectId, campaignId, runId],
        () =>
          "/v1/teams/" +
          __encodePathParam(teamId) +
          "/projects/" +
    ...
    CampaignControllerGetAccrualDetailForHour: (
      ...
      __makePathRequest(
        HttpClientRequest.get,
        [teamId, projectId, campaignId, hour],
        () =>
          "/v1/teams/" +
          __encodePathParam(teamId) +
          "/projects/" +
          ...
          "/campaigns/" +
          __encodePathParam(campaignId) +
          "/accrual-details/hour/" +
          __encodePathParam(hour) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    CampaignAdminControllerGetById: (campaignId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [campaignId],
        () => "/v1/admin/campaigns/" + __encodePathParam(campaignId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(["2xx"], undefined, {
    ...
    ProgrammaticCampaignControllerGetPayoutBatchDetail: (
      ...
      __makePathRequest(
        HttpClientRequest.get,
        [projectId, campaignId, runId, batchKey],
        () =>
          "/v1/programmatic/projects/" +
          __encodePathParam(projectId) +
          "/campaigns/" +
    ...
    CampaignV2SimulationAdminControllerList: (options) =>
      HttpClientRequest.get("/v2/admin/campaign-simulations").pipe(
        HttpClientRequest.setUrlParams({
          offset: options?.params?.["offset"] as any,
          limit: options?.params?.["limit"] as any,
        }),
    ...
    CampaignV2SimulationAdminControllerCreate: (options) =>
      HttpClientRequest.post("/v2/admin/campaign-simulations").pipe(
        HttpClientRequest.bodyJsonUnsafe(options.payload),
        onRequest(options.config)(["2xx"], undefined, {
          binary: [],
          voidSuccess: [],
    ...
    CampaignV2SimulationAdminControllerGetById: (simulationRunId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [simulationRunId],
        () =>
          "/v2/admin/campaign-simulations/" +
          __encodePathParam(simulationRunId) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    CampaignV2SimulationAdminControllerDelete: (simulationRunId, options) =>
      __makePathRequest(
    ...
    CampaignV2AdminControllerGetById: (campaignId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [campaignId],
        () => "/v2/admin/campaigns/" + __encodePathParam(campaignId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(["2xx"], undefined, {
    ...
    CampaignV2AdminControllerTopUpBudget: (campaignId, options) =>
      __makePathRequest(
        HttpClientRequest.post,
        [campaignId],
        () => "/v2/admin/campaigns/" + __encodePathParam(campaignId) + "/top-up"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.bodyJsonUnsafe(options.payload),
    ...
    CampaignV2AdminControllerUnlockMilestone: (
      ...
      __makePathRequest(
        HttpClientRequest.post,
        [campaignId, milestoneOrder],
        () =>
          "/v2/admin/campaigns/" +
          __encodePathParam(campaignId) +
          "/milestones/" +
          __encodePathParam(milestoneOrder) +
          "/unlock"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    ProgrammaticCampaignV2ControllerGetAccrualDetailForWindow: (
      ...
      __makePathRequest(
        HttpClientRequest.get,
        [projectId, campaignId, windowStart],
        () =>
          "/v2/programmatic/projects/" +
          __encodePathParam(projectId) +
          "/campaigns/" +
          __encodePathParam(campaignId) +
          "/accrual-details/window/" +
          __encodePathParam(windowStart) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    TeamsControllerListAuditLogs: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/audit-logs"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    TeamsControllerGetById: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(["2xx"], undefined, {
    ...
    ProgrammaticTeamsControllerCreate: (options) =>
      HttpClientRequest.post("/v1/programmatic/teams").pipe(
        HttpClientRequest.setHeaders({
          "X-ADMIN-API-KEY": options.params?.["X-ADMIN-API-KEY"] ?? undefined,
        }),
        HttpClientRequest.bodyJsonUnsafe(options.payload),
    ...
    ProjectsControllerGet: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/projects"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(onRequest(options?.config)(["2xx"]))
        )
    ...
    ProgrammaticProjectsControllerDelete: (projectId, options) =>
      __makePathRequest(
        HttpClientRequest.delete,
        [projectId],
        () => "/v1/programmatic/projects/" + __encodePathParam(projectId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
              "X-ADMIN-API-KEY":
                options?.params?.["X-ADMIN-API-KEY"] ?? undefined,
            }),
            onRequest(options?.config)([], undefined, {
              binary: [],
              voidSuccess: ["200"],
    ...
    ProgrammaticKeysControllerGet: (projectId, options) =>
      __makePathRequest(
        ...
        [projectId],
        () =>
          "/v1/programmatic/projects/" + __encodePathParam(projectId) + "/keys"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    PayoutAddressesControllerDelete: (
      ...
      __makePathRequest(
        HttpClientRequest.delete,
        [teamId, projectId, payoutAddressId],
        () =>
          "/v1/teams/" +
          __encodePathParam(teamId) +
          "/projects/" +
          __encodePathParam(projectId) +
          "/payout-addresses/" +
          __encodePathParam(payoutAddressId) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    PayoutRequestsControllerRequestPayout: (teamId, projectId, options) =>
      __makePathRequest(
        HttpClientRequest.post,
        [teamId, projectId],
        () =>
    ...
    ReferralControllerGetByCode: (code, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [code],
        () => "/v1/referrals/" + __encodePathParam(code) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    KpiSummaryControllerGetSummary: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/reporting/summary"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    KpiTrendsControllerGetTrends: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/reporting/trends"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    MonthlyReportControllerList: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/reporting/reports"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(onRequest(options?.config)(["2xx"]))
        )
      ),
    MonthlyReportControllerCreateDraft: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.post,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/reporting/reports"
    ...
    MonthlyReportControllerGetDetail: (teamId, reportId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId, reportId],
        () =>
    ...
    MonthlyReportControllerPublish: (teamId, reportId, options) =>
      __makePathRequest(
        HttpClientRequest.post,
        [teamId, reportId],
        () =>
    ...
    MonthlyReportControllerDownload: (teamId, reportId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId, reportId],
        () =>
    ...
    MonthlyReportControllerDownloadStream: (teamId, reportId) =>
      Stream.unwrap(
        __makePathRequest(
          HttpClientRequest.get,
          [teamId, reportId],
    ...
    ReportEntryControllerList: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/report-entries"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    ReportProjectControllerGetRewards: (integrationId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [integrationId],
        () => "/v1/reporting/rewards/" + __encodePathParam(integrationId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    ProgrammaticReportingControllerGetDailyPerformanceAggregates: (
      ...
      __makePathRequest(
        ...
        () =>
          "/v1/programmatic/projects/" +
          __encodePathParam(projectId) +
          "/reporting/performance/aggregate"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    ProgrammaticReportingControllerGetPerpActivity: (projectId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [projectId],
        () =>
    ...
    UsersControllerFindAll: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/users"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    UsersControllerResendInvitation: (teamId, id, options) =>
      __makePathRequest(
        HttpClientRequest.post,
        [teamId, id],
        () =>
    ...
    ActionControllerGetGasEstimate: (actionId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [actionId],
        () => "/v1/actions/" + __encodePathParam(actionId) + "/gas-estimate"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    NetworkGasControllerV2GetGasPrices: (network, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [network],
        () => "/v2/networks/" + __encodePathParam(network) + "/gas"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
        ...
        Effect.flatMap((request) =>
          request.pipe(
            ...
            onRequest(options.config)(
              ...
              { binary: [], voidSuccess: ["201"], voidError: [] }
            )
          )
        )
      ),
    TransactionControllerGetTransactionStatusFromId: (transactionId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [transactionId],
        () => "/v1/transactions/" + __encodePathParam(transactionId) + "/status"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    TransactionControllerGetGasForNetwork: (network, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [network],
        () => "/v1/transactions/gas/" + __encodePathParam(network) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    TransactionControllerGetTransactionVerificationMessageForNetwork: (
      ...
      __makePathRequest(
        HttpClientRequest.post,
        [network],
        () => "/v1/transactions/verification/" + __encodePathParam(network) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    NetworkTokensV2ControllerGetTokens: (network, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [network],
        () => "/v2/networks/" + __encodePathParam(network) + "/addresses/tokens"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    EnabledYieldControllerDelete: (teamId, projectId, integrationId, options) =>
      __makePathRequest(
        HttpClientRequest.delete,
        [teamId, projectId, integrationId],
        () =>
          "/v1/teams/" +
          __encodePathParam(teamId) +
          "/projects/" +
          __encodePathParam(projectId) +
          "/yields/enabled/" +
          __encodePathParam(integrationId) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
        ...
        Effect.flatMap((request) =>
          request.pipe(
            ...
            onRequest(options.config)(
              ...
              { binary: [], voidSuccess: [], voidError: ["400"] }
            )
          )
        )
      ),
        ...
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(
              ...
              { binary: [], voidSuccess: ["204"], voidError: ["404"] }
            )
          )
        )
      ),
    ...
    YieldControllerYieldOpportunity: (integrationId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [integrationId],
        () => "/v1/yields/" + __encodePathParam(integrationId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    YieldControllerGetValidators: (integrationId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [integrationId],
        () => "/v1/yields/" + __encodePathParam(integrationId) + "/validators"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    YieldControllerGetSingleYieldBalances: (integrationId, options) =>
      __makePathRequest(
        HttpClientRequest.post,
        [integrationId],
        () => "/v1/yields/" + __encodePathParam(integrationId) + "/balances"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    YieldControllerGetSingleYieldRewardsSummary: (integrationId, options) =>
      __makePathRequest(
        ...
        [integrationId],
        () =>
          "/v1/yields/" + __encodePathParam(integrationId) + "/rewards-summary"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    YieldV2ControllerGetYieldById: (yieldId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [yieldId],
        () => "/v2/yields/" + __encodePathParam(yieldId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setHeaders({
    ...
    YieldV2ControllerFindYieldValidators: (yieldId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [yieldId],
        () => "/v2/yields/" + __encodePathParam(yieldId) + "/validators"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    EarnControllerGetStakes: (network, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [network],
        () => "/v1/earn/" + __encodePathParam(network) + "/stakes"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.setUrlParams({
    ...
    FeeConfigurationControllerDelete: (
      ...
      __makePathRequest(
        ...
        () =>
          ...
          __encodePathParam(projectId) +
          "/fee-configuration/" +
          __encodePathParam(feeConfigurationId) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    RiskParametersControllerFindOne: (riskParameterId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [riskParameterId],
        () => "/v1/risk-parameters/" + __encodePathParam(riskParameterId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(["2xx"], undefined, {
    ...
    SsoConfigControllerGet: (teamId, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [teamId],
        () => "/v1/teams/" + __encodePathParam(teamId) + "/sso"
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(["2xx"], undefined, {
    ...
    MfaControllerDeleteWebauthnCredential: (credentialId, options) =>
      __makePathRequest(
        ...
        [credentialId],
        () =>
          "/v1/auth/mfa/webauthn/credentials/" +
          __encodePathParam(credentialId) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    ValidatorControllerFindOneProvider: (id, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [id],
        () => "/v1/validator/providers/" + __encodePathParam(id) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(["2xx"], undefined, {
    ...
    ValidatorControllerUpdateHistoricalRevshareChange: (id, options) =>
      __makePathRequest(
        ...
        [id],
        () =>
          "/v1/validator/historical-revshare-changes/" +
          __encodePathParam(id) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
    ...
    ValidatorControllerFindOne: (id, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [id],
        () => "/v1/validator/" + __encodePathParam(id) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(["2xx"], undefined, {
    ...
    AdminApiKeysControllerFindOne: (id, options) =>
      __makePathRequest(
        HttpClientRequest.get,
        [id],
        () => "/v1/programmatic-api-keys/" + __encodePathParam(id) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(onRequest(options?.config)(["2xx"]))
        )
    ...
    AdminApiKeysControllerRemove: (id, options) =>
      __makePathRequest(
        ...
        Effect.flatMap((request) =>
          request.pipe(onRequest(options?.config)([]))
        )
      ),
        ...
        Effect.flatMap((request) =>
          request.pipe(
            onRequest(options?.config)(
              ...
              { binary: [], voidSuccess: ["204"], voidError: ["400", "404"] }
            )
          )
        )
      ),
    ...
    WebhooksControllerGetSubscription: (
      ...
      __makePathRequest(
        HttpClientRequest.get,
        [teamId, projectId, subscriptionId],
        () =>
          "/v1/teams/" +
          __encodePathParam(teamId) +
          "/projects/" +
          ...
          __encodePathParam(subscriptionId) +
          ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
    ...
    YieldStatusControllerUpsert: (integrationId, options) =>
      __makePathRequest(
        HttpClientRequest.put,
        [integrationId],
        () => "/v1/yield-status/" + __encodePathParam(integrationId) + ""
      ).pipe(
        Effect.flatMap((request) =>
          request.pipe(
            HttpClientRequest.bodyJsonUnsafe(options.payload),
...
export interface LegacyApi {
  ...
  readonly CampaignControllerCreate: <Config extends OperationConfig>(
    ...
    HttpClientError.HttpClientError | LegacyApiError<"403", undefined>
  >;
  ...
  readonly CampaignAdminControllerGetById: <Config extends OperationConfig>(
    ...
    HttpClientError.HttpClientError | LegacyApiError<"404", undefined>
  >;
  /**
  ...
  >(
    ...
    WithOptionalResponse<
      ...
      Config
    >,
    HttpClientError.HttpClientError | LegacyApiError<"412", undefined>
  >;
  ...
  readonly CampaignLifecycleControllerResume: <Config extends OperationConfig>(
    ...
    campaignId: string,
    options: {
      readonly payload: CampaignLifecycleControllerResumeRequestJson;
      readonly config?: Config | undefined;
    }
  ) => Effect.Effect<
  ...
  >;
  /**
   * List simulation runs, newest first (SuperAdmin).
   */
  readonly CampaignV2SimulationAdminControllerList: <
    Config extends OperationConfig,
  >(
    options:
      | {
          readonly params?:
            | CampaignV2SimulationAdminControllerListParams
            | undefined;
          readonly config?: Config | undefined;
        }
      | undefined
  ) => Effect.Effect<
    WithOptionalResponse<CampaignV2SimulationAdminControllerList200, Config>,
    HttpClientError.HttpClientError
  >;
  /**
   * Clone a real campaign as an isSimulation copy and queue a simulation run (SuperAdmin, staging only). The cron runner drives it; results land in the real campaign_v2 tables under the clone.
   */
  readonly CampaignV2SimulationAdminControllerCreate: <
    Config extends OperationConfig,
  >(options: {
    readonly payload: CampaignV2SimulationAdminControllerCreateRequestJson;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
    WithOptionalResponse<CampaignV2SimulationAdminControllerCreate201, Config>,
    | HttpClientError.HttpClientError
    | LegacyApiError<"404", undefined>
    | LegacyApiError<"412", undefined>
  >;
  /**
   * Get a simulation run with its result summary (SuperAdmin).
   */
  readonly CampaignV2SimulationAdminControllerGetById: <
    Config extends OperationConfig,
  >(
    simulationRunId: string,
    options: { readonly config?: Config | undefined } | undefined
  ) => Effect.Effect<
    WithOptionalResponse<CampaignV2SimulationAdminControllerGetById200, Config>,
    HttpClientError.HttpClientError | LegacyApiError<"404", undefined>
  >;
  /**
   * Delete a simulation run, its campaign clone and all child rows (SuperAdmin).
   */
  readonly CampaignV2SimulationAdminControllerDelete: <
    Config extends OperationConfig,
  >(
    simulationRunId: string,
    options: { readonly config?: Config | undefined } | undefined
  ...
  readonly TeamsControllerUpdate: <Config extends OperationConfig>(
    ...
    HttpClientError.HttpClientError
  >;
  readonly ProgrammaticTeamsControllerCreate: <
    Config extends OperationConfig,
  >(options: {
    readonly params?: ProgrammaticTeamsControllerCreateParams | undefined;
    readonly payload: ProgrammaticTeamsControllerCreateRequestJson;
    readonly config?: Config | undefined;
  }) => Effect.Effect<
    WithOptionalResponse<ProgrammaticTeamsControllerCreate201, Config>,
    HttpClientError.HttpClientError
  >;
  ...
  >;
  /**
   * Creates a pending payout request for a completed claimable calendar month on one project. Locks claimable legacy revenue via a project-scoped high-water-mark snapshot. Requires addressesConfirmed=true and a payout destination per claimable network (from project Settings and/or payoutAddresses in the body). Enforces the minimum claimable USD threshold.
   */
  readonly PayoutRequestsControllerRequestPayout: <
    Config extends OperationConfig,
  >(
    teamId: string,
    projectId: string,
    options: {
      readonly payload: PayoutRequestsControllerRequestPayoutRequestJson;
      readonly config?: Config | undefined;
    }
  ) => Effect.Effect<
    WithOptionalResponse<PayoutRequestsControllerRequestPayout201, Config>,
    | HttpClientError.HttpClientError
    | LegacyApiError<"400", undefined>
    | LegacyApiError<"409", undefined>
    | LegacyApiError<"412", undefined>
  >;
  ...
  readonly KpiSummaryControllerGetSummary: <Config extends OperationConfig>(
    ...
    HttpClientError.HttpClientError | LegacyApiError<"400", undefined>
  >;
  /**
  ...
  >;
  /**
   * Monthly reports for the team, sorted by month descending. Team users see published reports only; super admins also see drafts.
   */
  readonly MonthlyReportControllerList: <Config extends OperationConfig>(
    teamId: string,
    options: { readonly config?: Config | undefined } | undefined
  ) => Effect.Effect<
    WithOptionalResponse<MonthlyReportControllerList200, Config>,
    HttpClientError.HttpClientError
  >;
  /**
   * Super admin only. Freezes the per-integration revenue breakdown for the month into a snapshot and stores it as a draft for review. Re-drafting a month overwrites the snapshot and reverts a published report to draft.
   */
  readonly MonthlyReportControllerCreateDraft: <Config extends OperationConfig>(
    teamId: string,
    options: {
      readonly payload: MonthlyReportControllerCreateDraftRequestJson;
      readonly config?: Config | undefined;
    }
  ) => Effect.Effect<
    WithOptionalResponse<MonthlyReportControllerCreateDraft201, Config>,
    HttpClientError.HttpClientError | LegacyApiError<"412", undefined>
  >;
  /**
   * Full integration breakdown, TVL snapshot, and fee data for the month, plus a CSV download URL. Drafts are visible to super admins only.
   */
  readonly MonthlyReportControllerGetDetail: <Config extends OperationConfig>(
    teamId: string,
    reportId: string,
    options: { readonly config?: Config | undefined } | undefined
  ) => Effect.Effect<
    WithOptionalResponse<MonthlyReportControllerGetDetail200, Config>,
    HttpClientError.HttpClientError | LegacyApiError<"404", undefined>
  >;
  /**
   * Super admin only. Transitions a draft report to published so the team can see it. Idempotent for already-published reports.
   */
  readonly MonthlyReportControllerPublish: <Config extends OperationConfig>(
    teamId: string,
    reportId: string,
    options: { readonly config?: Config | undefined } | undefined
  ) => Effect.Effect<
    WithOptionalResponse<MonthlyReportControllerPublish200, Config>,
    HttpClientError.HttpClientError | LegacyApiError<"404", undefined>
  >;
  /**
   * Streams the per-integration breakdown for the report as a CSV file. Drafts are downloadable by super admins only.
   */
  readonly MonthlyReportControllerDownload: <Config extends OperationConfig>(
    teamId: string,
    reportId: string,
    options: { readonly config?: Config | undefined } | undefined
  ) => Effect.Effect<
   ...
   * Streams the per-integration breakdown for the report as a CSV file. Drafts are downloadable by super admins only.
   */
  readonly MonthlyReportControllerDownloadStream: (
    teamId: string,
    reportId: string
  ) => Stream.Stream<Uint8Array, HttpClientError.HttpClientError>;
  ...
  >;
  /**
   * Retrieve a paginated chronological feed of perp actions and timeline events for a project owned by the authenticated team. Omitting address returns all project activity in the selected timestamp range. Optional filters: provider, address, market, action status, and action type.
   */
  readonly ProgrammaticReportingControllerGetPerpActivity: <
    Config extends OperationConfig,
  >(
    projectId: string,
    options: {
      readonly params: ProgrammaticReportingControllerGetPerpActivityParams;
      readonly config?: Config | undefined;
    }
  ) => Effect.Effect<
    WithOptionalResponse<
      ProgrammaticReportingControllerGetPerpActivity200,
      Config
    >,
    HttpClientError.HttpClientError
  >;
  ...
  readonly UsersControllerUpdate: <Config extends OperationConfig>(
    ...
    HttpClientError.HttpClientError
  >;
  readonly UsersControllerResendInvitation: <Config extends OperationConfig>(
    teamId: string,
    id: string,
    options: { readonly config?: Config | undefined } | undefined
  ) => Effect.Effect<
    WithOptionalResponse<UsersControllerResendInvitation200, Config>,
    HttpClientError.HttpClientError
  >;
  /**
  ...
  >;
  /**
   * Returns a paginated list of actions with associated transactions. STALE actions are excluded unless a status filter is provided
   */
  ...
  >(options: {
    ...
    | HttpClientError.HttpClientError
    | LegacyApiError<"400", undefined>
    | LegacyApiError<"401", undefined>
    | LegacyApiError<"403", undefined>
    | LegacyApiError<"429", undefined>
  >;
