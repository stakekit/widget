...
export const selectOpportunity = async () => {
  ...
  await waitFor(() => expect(getByText("Connect Wallet")).toBeInTheDocument());
  ...
  selectContainer = await waitFor(() => getByTestId("select-modal__container"));
